...
! ----------------------------------------------------------
  ...
  if (water) then
    ...
    open(53, file = "outputfiles/Deviatoricplan", status="unknown")
  ...
  open(21, file = "outputfiles/strainxz", status = "unknown")
  open(22, file = "outputfiles/strainyz", status = "unknown")
  open(23, file = "outputfiles/strainzz", status = "unknown")
...
!
  ...
  ! Anisotropy exanple to have the same Peff0
